...
export const MOVIECREDITS = ({ id }) => `https://api.themoviedb.org/3/movie/${id}/credits?${AUTH}`;
export const SEASONDETAILS = ({ id, seasonNumber, lang = 'en-US' }) => `https://api.themoviedb.org/3/tv/${id}/season/${seasonNumber}?${AUTH}&lang=${lang}`
...
export const GETRATEDMOVIES = ({ guestId }) => `https://api.themoviedb.org/3/guest_session/${guestId}/rated/movies?${AUTH}`
export const GETRATEDTVSHOWS = ({ guestId }) => `https://api.themoviedb.org/3/guest_session/${guestId}/rated/tv?${AUTH}`